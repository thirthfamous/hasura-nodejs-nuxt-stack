<template>
  <div class="row">
    <div class="col-md-12 bg-white">
      ...
      <NuxtLink to="/mahasiswa/tambah" class="btn btn-success pull-right" style="margin-bottom: 20px">
        <i class="fas fa-plus-square" /> Tambah Mahasiswa
      </NuxtLink>
      <a style="margin-right: 7px;" class="btn btn-info pull-right" @click="filter = !filter"><i class="fas fa-filter" />Filter</a>
...
export default {
  ...
  methods: {
    ...
    processFilter () {
      this.offset = 0
      this.$router.push({ path: '/mahasiswa/', query: { nim: this.nim } })
      this.fetchMahasiswa()
    },
    fetchMahasiswa () {
